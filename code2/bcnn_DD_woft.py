...
if __name__ == '__main__':
    ...
    total_train_data = h5py.File('../data/totaltrain_crop.h5', 'r')
    ...
    optimizer = tf.train.MomentumOptimizer(learning_rate=0.5, momentum=0.9).minimize(loss)
    ...
    for epoch in range(epoch):
        avg_cost = 0.
        total_batch = int(step/batch_size)
        ...
        if epoch==break_training_epoch:
            ...
            np.savez('last_layers_epoch_10_total.npz',last_layer_weights)
